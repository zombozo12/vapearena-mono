...
export function Navigation({is_logged_in}: NavigationProps) {
    return (
                                ...
                                <div className="w-full max-w-lg lg:max-w-xs">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            id="search"
                                            name="search"
                                            className="block w-full rounded-md border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 placeholder:text-gray-500 focus:border-indigo-500 focus:placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"
                                            placeholder="Search"
                                            type="search"
                                        />
                                    </div>
